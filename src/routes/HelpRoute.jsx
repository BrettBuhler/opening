...
const HelpRoute = ({userInfo}) => {
    ...
    const editLineText = `The Edit Line feature allows you to modify lines in the database. After clicking the Edit Line button, chose what line you want to edit from the menu. "Delete" will remove the selected line from the database, "Add Side-line" will let you fork a line, "Edit Line" will let you replace part of a line with a new sequence of moves, and "Help" brings you here. Add Side-line will add a new fork to the line, where Edit Line will overwrite a line from a selected position. If you select Add Side-line or Edit line, you will see a chessboard with a select menu below. Select the position you wish to edit from, then click the continue button. Then, input the edited line or side-line and click the save button to save the changes to the database.`
